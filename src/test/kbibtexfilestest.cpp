...
void KBibTeXFilesTest::initTestCase()
{
    ...
    if (rawDataFile.open(QFile::WriteOnly)) {
        ...
        ts << QStringLiteral("SPDX-License-Identifier: BSD-2-Clause") << Qt::endl;
        ts << QStringLiteral("SPDX-FileCopyrightText: ") << QDate::currentDate().year() << QStringLiteral(" Thomas Fischer <fischer@unix-ag.uni-kl.de> and others") << Qt::endl << Qt::endl;
        ts << QStringLiteral("********************************************************************************/") << Qt::endl << Qt::endl;
        ...
        ts << QStringLiteral("SPDX-License-Identifier: BSD-2-Clause") << endl;
        ts << QStringLiteral("SPDX-FileCopyrightText: ") << QDate::currentDate().year() << QStringLiteral(" Thomas Fischer <fischer@unix-ag.uni-kl.de> and others") << endl << endl;
        ts << QStringLiteral("********************************************************************************/") << endl << endl;
