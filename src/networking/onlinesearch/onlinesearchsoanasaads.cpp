...
public:
    ...
    QUrl buildSearchUrl(const QMap<QString, QString> &query, int numResults)
    {
...
void OnlineSearchSOANASAADS::startSearch(const QMap<QString, QString> &query, int numResults)
{
